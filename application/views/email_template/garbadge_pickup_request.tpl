        ...
        <td><table cellpadding="
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 36px;">
                                                    <span style="color:#222222">Garbage Pickup Request 
                                                        <br></span>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    ...
                                                    <p style="font-size: 16px; margin-bottom:30px">Thank you for submitting your garbage pickup request! We appreciate your effort in keeping our city clean and green. Our team will process your request shortly.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
