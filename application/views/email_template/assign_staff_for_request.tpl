        ...
        <td><table cellpadding="
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 36px;">
                                                    <span style="color:#222222">Staff Assigned for Pickup
                                                        <br></span>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    ...
                                                    <p style="font-size: 16px; margin-bottom:30px">Your pickup request has been assigned to our staff and will be processed shortly.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td style="padding: 20px 0; color:#222222">
                                                    ...
                                                    <table width="100%" cellpadding="0" cellspacing="0" height="60px">
                                                        <tr>
                                                            <td
                                                                width="50%"
                                                                style="border-right:1px solid #e0e0e0;padding: 5px 0px;">
                                                                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="vertical-align: top; padding-right: 10px;">
                                                                                <img
                                                                                    src="<%base_url()%>public/assets/images//phone-icon.png"
                                                                                    width="30"
                                                                                    height="30"
                                                                                    alt="Calendar Icon"
                                                                                    style="display: block;margin-top: 9px;">
                                                                            ...
                                                                            <td style="vertical-align: top;word-break: break-word;">
                                                                                <span style="font-size:12px;color:#666666;">Phone</span><br>
                                                                                <div style="font-size:16px; color:#000000;margin-top:5px;">
                                                                                    <a href="tel:<%$staff_phone_number%>" style="text-decoration:none">
                                                                                        <font color="#000000"><%$staff_phone_number%></font>
                                                                                    </a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                                ...
                                                                <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td style="vertical-align: top; padding-right: 10px;">
                                                                                <img
                                                                                    src="<%base_url()%>public/assets/images//mail-icon.png"
                                                                                    width="30"
                                                                                    height="30"
                                                                                    alt="Calendar Icon"
                                                                                    style="display: block;margin-top: 9px;">
                                                                            ...
                                                                            <td style="vertical-align: top;word-break: break-word;">
                                                                                <span style="font-size:12px;color:#666666;">Email</span><br>
                                                                                <div style="font-size:16px; color:#000000;margin-top:5px;">
                                                                                    <a href="tel:<%$staff_email%>" style="text-decoration:none">
                                                                                        <font color="#000000"><%$staff_email%></font>
                                                                                    </a>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                            ...
                                            <p style="font-size: 16px; margin-bottom:30px">Our team has assigned a staff member to your request.</p>
                                            <p style="font-size: 16px; margin-bottom:30px">If you have any changes to your request, please contact our support team or create a new pickup request.</p>
                                        </td>
                                    </tr>
