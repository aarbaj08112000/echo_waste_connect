        ...
        <td><table cellpadding="
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 36px;">
                                                    <span style="color:#222222">Garbage Pickup Request Is Cancelled
                                                        <br></span>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    ...
                                                    <p style="font-size: 16px; margin-bottom:30px">Your garbage pickup request has been cancelled.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <p style="font-size: 16px; margin-bottom:30px">Our team will not be processing this request further.</p>
                                            <p style="font-size: 16px; margin-bottom:30px">If you still require pickup service, you can easily submit a new request anytime.</p>
                                        </td>
                                    </tr>
