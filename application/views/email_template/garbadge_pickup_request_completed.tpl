        ...
        <td><table cellpadding="
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 36px;">
                                                    <span style="color:#222222">Your Garbage Pickup Has Been Successfully Completed
                                                        <br></span>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    ...
                                                    <p style="font-size: 16px; margin-bottom:30px">Your garbage pickup request has been completed.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <p style="font-size: 16px; margin-bottom:30px">Our staff has successfully completed your garbage pickup request.</p>
                                            <p style="font-size: 16px; margin-bottom:30px">Thank you for your cooperation in keeping the city clean!</p>
                                        </td>
                                    </tr>
