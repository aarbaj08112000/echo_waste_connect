        ...
        <td><table cellpadding="
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 36px;">
                                                    <span style="color:#222222">Your Garbage Pickup Request Is In Progress
                                                        <br></span>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="padding-top: 20px;">
                                                    ...
                                                    <p style="font-size: 16px; margin-bottom:30px">Your garbage pickup request has been started.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <p style="font-size: 16px; margin-bottom:30px">Our team has started processing your garbage pickup request.</p>
                                            <p style="font-size: 16px; margin-bottom:30px">Our staff is currently working on your request and will complete the pickup soon.</p>
                                        </td>
                                    </tr>
