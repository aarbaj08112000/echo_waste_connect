                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        if ($customer_part_rate) {
                                            foreach ($customer_part_rate as $poo) {
                                                ...
                                                // );
                                                $customer_part_rate_data = $this->Crud->get_data_by_id("customer_part_operation", $poo->id, 'id');
                            ...
                            <td>
                                <a class="btn btn-info" href="<?php echo base_url('add_operation_details/') . $customer_part_rate_data[0]->id . "/" . $customer_id . "/" . $this->uri->segment('2') . "/" .  $this->uri->segment('3');; ?>">Add Details</a>
                            </td>
