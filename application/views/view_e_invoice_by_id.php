                        ...
                        <div class="card">
							...
							<div class="row">
									 <div class="col-lg-1">
									  ...
									  <div class="col-lg-2">
										<div class="form-group">
											<a class="btn btn-dark" href="<?php echo base_url('view_new_sales_by_id/') . $this->uri->segment('2'); ?>">View Invoice </a>
                                        </div>
									</div>
							</div>
                                <div class="row">
							 ...
							 <div class="row">
								...
								if (empty($status)) {
										...
										<div class="col-lg-2">
											<div class="form-group">
												<a class="btn btn-success mt-4" href="<?php echo base_url('generate_E_invoice/') . $this->uri->segment('2') . "/EINVOICE"; ?>" target="_blank">Create E-Invoice </a>
											</div>
										</div>
										<?php
										 }else { 
										 ?>
											<div class="col-lg-2">
											<div class="form-group">
												<a class="btn btn-success mt-4" href="<?php echo base_url('get_E_invoice/') . $this->uri->segment('2'); ?>">Get E-Invoice Details</a>
											</div>
										</div>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="form-group">
                                            <a class="btn btn-success mt-4" href="<?php echo base_url('view_E_invoice/') . $this->uri->segment('2'); ?>" target="_blank">View E-Invoice </a>
                                        </div>
                                    </div>
									<div class="col-lg-2">
                                        <div class="form-group">
                                            <button data-toggle="modal" class="btn btn-success mt-4" data-target="#cancelEInvoiceModel<?php echo $this->uri->segment('2'); ?>">Cancel E-Invoice</i></button>
                                        </div>
                                    </div>
											<!-- Cancel E-Invoice Model -->
											<div class="modal fade" id="cancelEInvoiceModel<?php echo $this->uri->segment('2'); ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input value="<?php echo $this->uri->segment('2') ?>" type="hidden" name="new_sales_id" required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
                                                                                    </div>
                                                                                </div>
									...
									<!-- <div class="col-lg-2">
                                        <div class="form-group">
                                            <a class="btn btn-success mt-4" href="<?php echo base_url('cancel_EWay_Bill_update/') . $this->uri->segment('2'); ?>">Cancel E-Way Bill </a>
                                        </div>
                                    </div> -->
                                   <?php } ?>
                             </div>
							 <div class="row">
								...
								<div class="col-lg-2">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mt-4" data-toggle="modal" data-target="#createEBill<?php echo $this->uri->segment('2'); ?>" target="_blank">Create Eway Bill</button>
                                        </div>
                                </div>
								<?php 
								...
								<div class="col-lg-2">
                                        <div class="form-group">
                                            <a class="btn btn-success mt-4" href="<?php echo base_url('view_EwayBill/') . $this->uri->segment('2'); ?>" target="_blank">View EWay-Bill</a>
                                        </div>
                                </div>
							 	<div class="col-lg-2">
                                        <div class="form-group">
                                            <button type="button" class="btn btn-success mt-4" data-toggle="modal" data-target="#updateEBill<?php echo $this->uri->segment('2'); ?>">Update Eway Bill</button>
                                        </div>
                                </div>
								<div class="col-lg-2">
										<div class="form-group">
											<button type="button" class="btn btn-success mt-4" data-toggle="modal" data-target="#updateTrans<?php echo $this->uri->segment('2'); ?>">Update Transporter</button>
										</div>
								</div>
								<div class="col-lg-2">
										<div class="form-group">
											<button type="button" class="btn btn-success mt-4" data-toggle="modal" data-target="#cancelEBill<?php echo $this->uri->segment('2'); ?>">Cancel Eway-Bill</button>
										</div>
								</div>
								<?php 
									}
                                ?>
												<!-- edit Modal -->
                                                <div class="modal fade" id="createEBill<?php echo $this->uri->segment('2'); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
												...
												<!-- Update Modal -->
                                                <div class="modal fade" id="updateEBill<?php echo $this->uri->segment('2'); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                ...
                                                <div class="modal fade" id="updateTrans<?php echo $this->uri->segment('2'); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
												...
												<!-- cancel eway bill -->
												<div class="modal fade" id="cancelEBill<?php echo $this->uri->segment('2'); ?>" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="modal-body">
																		...
																		<input type="hidden" name="new_sales_id" value="<?php echo $this->uri->segment('2') ?>"   required class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Customer Name">
