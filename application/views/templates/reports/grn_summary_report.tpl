  ...
  <div class="simplebar-content" >
    <ul class="menu-inner py-1">
        ...
        <!--  <div class="filter-row">
          ...
          <li class="sidebar-item">
            <div class="input-group">
           <input type="text" name="hsn_code_search" class=" form-control" id="hsn_code_search" />
            </div>
          </li>
        </div> -->
        <div class="filter-row">
      ...
      <div class="sub-header-left pull-left breadcrumb">
        <h1>
          ...
          <a hijacked="yes" href="#stock/issue_request/index" class="backlisting-link" title="Back to Issue Request Listing" >
            ...
            <em >GRN Summary Reports</em></a>
        </h1>
        <br>
        <span >GRN Summary Reports</span>
      </div>
    </nav>
    <div class="dt-top-btn d-grid gap-2 d-md-flex justify-content-md-end mb-5">
      <%if checkGroupAccess("grn_summary_report","export","No") %>
            ...
            <div class="card-header">
                <div class="row">
                    <div class="tgdp-rgt-tp-sect ms-2">
                        <p class="tgdp-rgt-tp-ttl">Basic Amount Total</p>
                        <p class="tgdp-rgt-tp-txt total_balance_amount">
                            0.00
                        </p>
                    </div>
                    <div class="tgdp-rgt-tp-sect">
                        <p class="tgdp-rgt-tp-ttl">GST Total Amount</p>
                        <p class="tgdp-rgt-tp-txt total_gst_amount">
                             0.00
                        </p>
                    </div>
                    <div class="tgdp-rgt-tp-sect">
                        <p class="tgdp-rgt-tp-ttl">Total Amount With GST</p>
                        <p class="tgdp-rgt-tp-txt total_amount_with_gst_amount" title="12">
                             0.00
                        </p>
                    </div>
...
<script src="<%$base_url%>/public/js/reports/grn_summary_report.js"></script>