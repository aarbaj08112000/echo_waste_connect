              ...
              <div class="row">
                ...
                <div class="col-lg-2">
                  <div class="form-group">
                    ...
                    <input type="number" step="any" min="0.00" value="<%$new_sales[0]->debit_basic_amt %>" required name="debit_basic_amt"
                    class="form-control">
                  </div>
                </div>
                <div class="col-lg-2">
                  <div class="form-group">
                    ...
                    <input type="number" step="any" value="<%$new_sales[0]->debit_gst_amt %>" required min="0.00" name="debit_gst_amt"
                    class="form-control">
                  </div>
                </div>
                <div class="col-lg-2">
        ...
        <div class="modal fade" id="accpet" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal fade" id="lock" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="table-responsive text-nowrap">
              <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="view_rejection_sales_invoice_by_id">
                <thead>
                  <tr>
                    <th>Sr No</th>
                    <th>Part Number</th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="" data-bs-toggle="modal" data-bs-target="#exampleModal<%$i %>">
                        <i class="ti ti-edit"></i>
                      </button>
                      <button type="button" class=" ml-1" data-bs-toggle="modal" data-bs-target="#exampleModaldelete<%$i %>">
                          ...
                          <div class="modal fade" id="acceptReject<%$i %>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="<%base_url('update_parts_rejection_sales_invoice') %>" method="POST" enctype='multipart/form-data' s>
                                    <div class="row">
                                      <div class="col-lg-12">
                                        <div class="form-group">
                                          <label for="">Qty</label>
