...
<div class="content-wrapper">
    ...
    <nav aria-label="breadcrumb">
      <div class="sub-header-left pull-left breadcrumb">
        <h1>
          ...
          <br>
          <span >View Supplier Challan Details Part Wise Subcon</span>
        </div>
      </nav>
      ...
      <div class="card p-0 mt-4">
        <div class="table-responsive text-nowrap">
          <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="view_supplier_challan_details_part_wise_subcon">
            <thead>
              <tr>
                <th>Sr. No.</th>
                <th>Part Number</th>
  ...
  <script src="<%$base_url%>public/js/store/view_supplier_challan_details_part_wise_subcon.js"></script>
