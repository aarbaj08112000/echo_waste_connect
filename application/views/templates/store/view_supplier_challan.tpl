...
<div class="content-wrapper">
            ...
            <tbody>
              ...
              <%if ($supplier) %>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary" href="<%base_url('view_supplier_challan_details/') %><%$c->id %>">View Challan Details</a>
                    </td>
                  </tr>
  ...
  <script src="<%$base_url%>public/js/store/view_supplier_challan_view.js"></script>
