                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<%base_url('addchildpart_supplier') %>" method="POST" enctype='multipart/form-data' s>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select required class="form-control select2" name="child_part_id" style="width: 100%;">
                                                                    ...
                                                                    <%foreach from=$child_part_list item=$c%>
                                                                    	<option value="<%$c->id %>"><%$c->part_number %>/<%$c->part_description %>/<%$c->uom_name %></option>
                                                                    <%/foreach%>
                                                                    <%/if%>
                                                                </select>
                                                            </div>
