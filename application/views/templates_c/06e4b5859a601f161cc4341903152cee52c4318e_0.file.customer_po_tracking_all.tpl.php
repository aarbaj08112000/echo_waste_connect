...
inwarding_by_po" method="POST">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
add_part" method="post"id="uploadForm" enctype='multipart/form-data'>
...
" type="hidden" name="uid" required class="form-control" id="uid" aria-describedby="emailHelp" placeholder="Customer Name">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
update_customer_po_tracking_all" method="POST" id="updateForm" enctype="multipart/form-data">
            <div class="modal-body">
                    <div class="form-group">
    ...
    <div class="modal fade" id="close_modal" tabindex="-1" role="dialog" aria-labelledby="close_modal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
close_po_customer_po_tracking" method="POST" id="closePoForm" enctype="multipart/form-data">
                    <div class="modal-body">
                            <div class="form-group">
                                <label for="" class="fs-4">Are you sure to close <u>PO Number : <?php echo $_smarty_tpl->tpl_vars['s']->value->po_number;?>
</u> ?</label>
                                
                                <input required value="<?php echo $_smarty_tpl->tpl_vars['s']->value->id;?>
" type="hidden" class="form-control" name="id" id='close_id'>
                            </div>
                            <div class="form-group">
