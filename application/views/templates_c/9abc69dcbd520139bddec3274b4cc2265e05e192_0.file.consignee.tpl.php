<?php
/* Smarty version 4.3.2, created on 2024-07-28 18:34:40
  from 'C:\xampp\htdocs\erp_converted\application\views\templates\customer\consignee.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_66a641e8f3f228_46815946',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9abc69dcbd520139bddec3274b4cc2265e05e192' => 
    array (
      0 => 'C:\\xampp\\htdocs\\erp_converted\\application\\views\\templates\\customer\\consignee.tpl',
      1 => 1722171879,
      2 => 'file',
    ),
  ),
...
function content_66a641e8f3f228_46815946 (Smarty_Internal_Template $_smarty_tpl) {
...
" type="text" name="uconsignee_name" required class="form-control" id="uconsignee_name" aria-describedby="emailHelp" placeholder="Consignee Name">
                                <input value="<?php echo $_smarty_tpl->tpl_vars['t']->value->c_id;?>
" type="hidden" name="consignee_id" required class="form-control" id="consignee_ref">
                                <input value="<?php echo $_smarty_tpl->tpl_vars['t']->value->address_id;?>
" type="hidden" name="address_id" required class="form-control" id="addressRef">
                            </div>
                            <div class="form-group">
                                <label for="customer_name">Location</label><span class="text-danger">*</span>
                                <input value="<?php echo $_smarty_tpl->tpl_vars['t']->value->location;?>
" type="text" name="ulocation" required class="form-control" id="location" aria-describedby="location" placeholder="Location">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">Address</label><span class="text-danger">*</span>
                                <input type="text" name="uaddress" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->address;?>
" required class="form-control" id="address" aria-describedby="emailHelp" placeholder="Address">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">State</label><span class="text-danger">*</span>
                                <input type="text" name="ustate" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->state;?>
" required class="form-control" id="state" aria-describedby="emailHelp" placeholder="State">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">State No </label><span class="text-danger">*</span>
                                <input type="text" name="ustate_no" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->state_no;?>
" required class="form-control" id="state_num" aria-describedby="emailHelp" placeholder="State No">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">PIN</label><span class="text-danger">*</span>
                                <input type="text" name="upin_code" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->pin_code;?>
" required class="form-control" id="PIN" aria-describedby="emailHelp" placeholder="PIN ">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">GST Number</label><span class="text-danger">*</span>
                                <input type="text" name="ugst_number" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->gst_number;?>
" required class="form-control" id="gst_no" aria-describedby="emailHelp" placeholder="GST Number">
                            </div>
                            <div class="form-group">
                                <label for="customer_location">PAN No</label><span class="text-danger">*</span>
                                <input type="text" name="upan_no" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->pan_no;?>
" required class="form-control" id="pan" aria-describedby="emailHelp" placeholder="PAN No">
                            </div>
                            <div class="form-group">
                                <label for="customer_name">Phone No</label><span class="text-danger">*</span>
                                <input type="text" name="uphone_no" value="<?php echo $_smarty_tpl->tpl_vars['t']->value->phone_no;?>
" required class="form-control" id="phone" aria-describedby="phone" placeholder="Phone No">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
