...
add_customer_parts_master" method="POST" id="addCustomerPartsForm" enctype="multipart/form-data">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                    <form action="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
update_customer_parts_master" id="updateCustomerPartsForm" method="POST" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                    <div class="form-group">
...
" name="id" required class="form-control" id="part_id" placeholder="Enter Safety/buffer stock" aria-describedby="emailHelp">
                                                        <input  type="text" name="part_description" placeholder="Enter Part Description" class="form-control" value="<?php echo $_smarty_tpl->tpl_vars['u']->value->part_description;?>
" id="edit-part-des">
                                                    </div>

                                                    <div class="form-group">
                                                        <label>Rate<span class="text-danger">*</span></label> <br>
                                                        <input  type="text" step="any" name="fg_rate" placeholder="Enter Rate" class="form-control onlyNumericInput" value="<?php echo $_smarty_tpl->tpl_vars['u']->value->fg_rate;?>
