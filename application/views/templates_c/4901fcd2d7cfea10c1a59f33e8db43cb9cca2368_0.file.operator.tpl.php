<?php
/* Smarty version 4.3.2, created on 2024-08-25 01:14:58
  from 'C:\xampp\htdocs\erp_converted\application\views\templates\admin\operator.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_66ca383aceb603_19082409',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4901fcd2d7cfea10c1a59f33e8db43cb9cca2368' => 
    array (
      0 => 'C:\\xampp\\htdocs\\erp_converted\\application\\views\\templates\\admin\\operator.tpl',
      1 => 1724528697,
      2 => 'file',
    ),
  ),
...
function content_66ca383aceb603_19082409 (Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <nav aria-label="breadcrumb">
      ...
      <div class="dt-top-btn d-grid gap-2 d-md-flex justify-content-md-end mb-5">
        ...
        <button class="btn btn-seconday" type="button" id="downloadPDFBtn" title="Download PDF"><i class="ti ti-file-type-pdf"></i></button>
           ...
           data-bs-target="#addPromo" title="Add Operator">
      ...
      <div class="modal fade" id="addPromo" tabindex="-1" role="dialog"
         ...
         <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <form action="<?php echo base_url('add_operator');?>
" method="POST"
                        enctype="multipart/form-data" id='add_operator'>
               <div class="modal-body">
                  <div class="form-group">
                  <label for="on click url">Name<span class="text-danger">*</span></label>
                  <br>
                  <input type="text" name="namess" placeholder="Enter Name"
                     class="form-control" value="" id="namess">
                  </div>
      ...
      <div class="card p-0 mt-4">
          ...
          <div class="table-responsive text-nowrap">
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="operator">
              <thead>
                 <tr>
                    <th>Sr No</th>
                    <th>Name</th>
              ...
              <tbody>
                  <?php if (($_smarty_tpl->tpl_vars['operator']->value)) {?>
                      ...
                      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['operator']->value, 'u');
...
public/js/admin/operator.js"><?php echo '</script'; ?>
>
<?php }
}
