...
function content_66d0be48773a31_67732319 (Smarty_Internal_Template $_smarty_tpl) {
...
>
      ...
      <?php echo '<script'; ?>
 src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.all.min.js"><?php echo '</script'; ?>
>
...
>
      <!-- swal toaster 
      <link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
public/plugin/sweetalert2/sweetalert2.min.css">
      <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
public/plugin/sweetalert2/sweetalert2.all.min.js"><?php echo '</script'; ?>
>-->
               ...
               <ul class="navbar-right-wrap ms-auto d-flex nav-top-wrap navbar-nav">
                  <li class="ms-2 dropdown">
                     <a class="rounded-circle  " id="dropdownUser" aria-expanded="false">
                        <div class="avatar avatar-md avatar-indicators avatar-online"><?php echo $_smarty_tpl->tpl_vars['session_data']->value['user_name'][0];?>
</div>
                     </a>
                     <div data-bs-popper="static" class="dropdown-menu dropdown-menu-end  dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser" id="dropdownUserNav">
                        <div data-rr-ui-dropdown-item="" class="px-4 pb-0 pt-2  ">
                           <div class="lh-1 ">
                              <h5 class="mb-1">  <?php echo $_smarty_tpl->tpl_vars['session_data']->value['user_name'];?>
</h5>
                              <a class="text-inherit fs-6" href="javascript:void(0)"><?php echo $_smarty_tpl->tpl_vars['session_data']->value['user_email'];?>
</a>
                             
                           </div>
                           <div class=" dropdown-divider mt-3 mb-2"></div>
                        </div>
                        <a data-rr-ui-dropdown-item="" class="dropdown-item" role="button" tabindex="0" href="<?php echo base_url('logout');?>
"><i class="ti ti-power me-2" ti></i>Sign Out</a>
                     </div>
                  </li>
               </ul>
            </div>
...
" class="dropdown-item">Transporter</a>
                        ...
                        <li><a class="dropdown-item" href="<?php echo base_url('erp_users');?>
">User</a></li>
                        <li><a class="dropdown-item" href="<?php echo base_url('configs');?>
">Configurations</a></li>
                     </ul>
                  </li>
                  <?php }?>
