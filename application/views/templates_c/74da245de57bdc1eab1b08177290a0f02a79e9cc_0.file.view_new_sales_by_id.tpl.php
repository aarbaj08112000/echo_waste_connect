<?php
/* Smarty version 4.3.2, created on 2024-06-18 19:12:57
  from '/var/www/html/extra_work/erp_converted/application/views/templates/planning_sales/view_new_sales_by_id.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_66718ee1b7a8d7_70846132',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '74da245de57bdc1eab1b08177290a0f02a79e9cc' => 
    array (
      0 => '/var/www/html/extra_work/erp_converted/application/views/templates/planning_sales/view_new_sales_by_id.tpl',
      1 => 1718711929,
      2 => 'file',
    ),
  ),
...
function content_66718ee1b7a8d7_70846132 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="wrapper">
               ...
               <div class="col-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        ...
                        <form action="<?php echo base_url('generate_new_sales_update');?>
" method="POST">
                           <div class="row">                     
                           </div>
...
" name="remark" class="form-control">
                                    <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['sales_id']->value;?>
...
">< Back </a>
                           ...
                           <div class="col-lg-1">
                              <div class="form-group">
                                 <a class="btn btn-success" href="<?php echo base_url('view_generate_sales_invoice/');
...
" target="_blank">View Original</a>
                           ...
                           <div class="col-lg-1">
                              <div class="form-group">
                                 <a class="btn btn-success" href="<?php echo base_url('generate_sales_invoice/');
echo $_smarty_tpl->tpl_vars['sales_id']->value;?>
...
/DUPLICATE_FOR_TRANSPORTER">Duplicate </a>
                           ...
                           <div class="col-lg-1">
                              <div class="form-group">
                                 <a class="btn btn-success" href="<?php echo base_url('generate_sales_invoice/');?>
 <?php echo $_smarty_tpl->tpl_vars['sales_id']->value;?>
...
/EXTRA_COPY">Extra Invoice</a>
                           ...
                           <div class="col-lg-1">
                              <div class="form-group">
                                 ...
                                 <!-- <a class="btn btn-info" href="<?php echo '<?php'; ?>
 echo base_url('print_packing_sticker/'); <?php echo '?>'; ?>
">Packaging Sticker</a> -->
                              </div>
                              <!-- Modal -->
                        ...
                        <!-- Print selection -->
                        <form action="<?php echo base_url('print_sales_invoice/');
echo $_smarty_tpl->tpl_vars['sales_id']->value;?>
" method="post">
                           <div class="row">
                              <div class="col-lg-1">
                  ...
                  <div class="card-header">
                     <div class="row">
                        <div class="col-lg-3">
                           <div class="form-group">
                              <form action="<?php echo base_url('add_sales_parts');?>
" method="post">
                                 ...
                                 <select name="po_id" id="customer_tracking" required class="form-control select2">
                                    <?php if (($_smarty_tpl->tpl_vars['po_parts']->value)) {?>
                                        <?php if (($_smarty_tpl->tpl_vars['customer_tracking']->value)) {?>
                                       		<?php
...
//<?php echo $_smarty_tpl->tpl_vars['c']->value->po_amedment_number;?>
</option>
				                                <?php }?>
		                                    <?php
}
...
?>
				                                    <option 
				                                    	<?php if (($_smarty_tpl->tpl_vars['po_parts']->value)) {?>
				                                           <?php if (($_smarty_tpl->tpl_vars['po_parts']->value[0]->po_id == $_smarty_tpl->tpl_vars['c']->value->id)) {?>
				                                               selected
				                                           <?php }?>
				                                       <?php }?>
...
" placeholder="Enter QTY " required class="form-control">
               ...
               <div class="card-header">
                  <?php if (($_smarty_tpl->tpl_vars['po_parts']->value)) {?>
                     	<?php if (($_smarty_tpl->tpl_vars['new_sales']->value[0]->status == "pending")) {?>
                         	<?php if (($_smarty_tpl->tpl_vars['user_type']->value == 'admin' || $_smarty_tpl->tpl_vars['user_type']->value == 'Admin' || $_smarty_tpl->tpl_vars['user_type']->value == 'Sales')) {?>
...
" required class="form-control">
                   ...
                   <?php }?>
	                  ...
	                  <?php } else { ?>
		                    <?php if (($_smarty_tpl->tpl_vars['new_sales']->value[0]->status != "pending")) {?>
			                    <?php if (($_smarty_tpl->tpl_vars['new_sales']->value[0]->status != "Cancelled")) {?>
                  ...
                  <div class="modal fade" id="lock" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                     <div class="modal-dialog">
                        <div class="modal-content">
                           ...
                           <div class="modal-body">
                              <div class="row">
                                 <form action="<?php echo base_url('lock_invoice');?>
" method="POST">
                                    <div class="col-lg-12">
                                       <div class="form-group">
...
?>
                               		...
                               		<?php $_smarty_tpl->_assignInScope('row_total', (float) $_smarty_tpl->tpl_vars['p']->value->total_rate+(float)$_smarty_tpl->tpl_vars['p']->value->tcs_amount);?>
	                                <?php $_smarty_tpl->_assignInScope('final_po_amount', (float) $_smarty_tpl->tpl_vars['final_po_amount']->value+(float)$_smarty_tpl->tpl_vars['row_total']->value);?>
	                                <?php $_smarty_tpl->_assignInScope('rate', (float)$_smarty_tpl->tpl_vars['subtotal']->value/(float)$_smarty_tpl->tpl_vars['p']->value->qty);?>
	                                <?php $_smarty_tpl->_assignInScope('db_part_price', $_smarty_tpl->tpl_vars['p']->value->part_price);?>
	                                <?php if (($_smarty_tpl->tpl_vars['db_part_price']->value > 0)) {?>
