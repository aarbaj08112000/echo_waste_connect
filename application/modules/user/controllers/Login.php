...
class Login extends MY_Controller {
	...
	public function index() {
		...
		$data['user_type'] = $current_route == "citizen_login" ? "citizen" : "user";
	...
	public function signin()
	{
		...
		if($user_type == "citizen"){
			$result = $this->Login_model->get_citizen_details($email, $password);
			if (!empty($result)) {
				$staff_code = "citizen";
				$group_data = $this->Login_model->get_group_master_details($staff_code);
				$result['user_role'] = $staff_code;
				$result['group_name'] = "Citizen";
				$result['groups'] = $group_data['group_master_id'];
			}	
		}else{
