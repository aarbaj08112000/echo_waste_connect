...
var table = '';
var file_name = "challan_subcon";
var pdf_title = "Challan Subcon";
...
const page = {
    ...
    initiateForm: function(){
      ...
      $(".add_challan_subcon").submit(function(e){
        e.preventDefault();
        let flag = that.formValidate("add_challan_subcon");
        if(flag){
          return;
        }
        var formData = new FormData($('.add_challan_subcon')[0]);

        $.ajax({
          type: "POST",
          url: base_url+"generate_challan_subcon",
