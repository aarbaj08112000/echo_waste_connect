...
$(document).ready(function() {
    ...
    table = new DataTable('#mold_maintenance', {
        dom: 'Bfrtip',
        scrollX: true,
        buttons: [
            {     
                ...
                customize: function(csv) {
                    ...
                    var modifiedLines = lines.map(function(line) {
                        ...
                        values.splice(7, 7); // Make sure this logic is correct for your use case
                        return values.join(',');
                    });
            ...
            },
            {
                ...
                customize: function(doc) {
                    ...
                    doc.content[1].table.body.forEach(function(row) {
                        ...
                        row.splice(7, 7); // Make sure this logic is correct for your use case
                    });
                }
            },
        ],
