...
const page = {
  ...
  initiateForm: function(){
    let that = this;
    $(".update_po_parts,.accept_po,.update_po,.add_po_parts,.unlock_po,.delete,.AmendQty,.update_po_parts_amendment,.update_po_parts_amendment_approve").submit(function(e){
        e.preventDefault();
