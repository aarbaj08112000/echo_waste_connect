...
var table = '';
var file_name = "rejected_po_list";
var pdf_title = "Rejected PO List";
const page = {
    init: function(){
        this.dataTable();
        // this.filter();
    ...
    dataTable: function(){
        var data = {};
        table = $("#rejected_po_view").DataTable({
        dom: "Bfrtilp",
        buttons: [
            {
                extend: "csv",
        ...
        columnDefs: [{ sortable: false, targets: 4 },{ sortable: false, targets: 5 },{ sortable: false, targets: 6 }],
