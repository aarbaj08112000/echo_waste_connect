var table = '';
var file_name = "sales_summary_reports";
var pdf_title = "Sales Summary Reports";
...
const page = {
    ...
    dataTable: function(){
        ...
        table = new DataTable("#receivable_report", {
            ...
            ajax: {
                data: {'search':data},    
                url: "ReportsController/getSalesSummaryReportData",
                type: "POST",
    ...
    resetFilter: function(){
        $("#customer_part_id").val('').trigger('change');
        $("#hsn_code_search").val('');
        dateRangePicker.setStartDate(start_date);
        dateRangePicker.setEndDate(end_date);
        table.destroy(); 
